...
for i=1:fsw*time
    ...
    HDFnew0121Q2(i)=((P2)^2+(P2)*(P3)+(P3)^2)*T1(i)*fraction5;
    HDFnew0121Q3(i)=((P3)^2+(P3)*(P4)+(P4)^2)*T2(i);
    HDFnew0121Q4(i)=((P4)^2+(P4)*(P5)+(P5)^2)*T1(i)*(1-fraction5);    
    R1 = 0;
    R2 = Dz(i);
    ...
    HDFnew0121D2(i)=((R2)^2+(R2)*(R3)+(R3)^2)*T1(i)*fraction5;
    HDFnew0121D3(i)=((R3)^2+(R3)*(R4)+(R4)^2)*T2(i);
    HDFnew0121D4(i)=((R4)^2+(R4)*(R5)+(R5)^2)*T1(i)*(1-fraction5);
    %HDFnew7212
    P1 = 0;
    P2 = Qz(i);
    ...
    HDFnew7212Q2(i)=((P2)^2+(P2)*(P3)+(P3)^2)*T2(i)*fraction5;
    HDFnew7212Q3(i)=((P3)^2+(P3)*(P4)+(P4)^2)*T1(i);
    HDFnew7212Q4(i)=((P4)^2+(P4)*(P5)+(P5)^2)*T2(i)*(1-fraction5);
    R1 = 0;
    R2 = Dz(i);
    ...
    HDFnew7212D2(i)=((R2)^2+(R2)*(R3)+(R3)^2)*T2(i)*fraction5;
    HDFnew7212D3(i)=((R3)^2+(R3)*(R4)+(R4)^2)*T1(i);
    HDFnew7212D4(i)=((R4)^2+(R4)*(R5)+(R5)^2)*T2(i)*(1-fraction5);
end
...
HDFnew0121Q = HDFnew0121Q1+HDFnew0121Q2+HDFnew0121Q3+HDFnew0121Q4;
HDFnew0121D = HDFnew0121D1+HDFnew0121D2+HDFnew0121D3+HDFnew0121D4;
HDFnew0121 = HDFnew0121Q+HDFnew0121D;
HDFnew7212Q = HDFnew7212Q1+HDFnew7212Q2+HDFnew7212Q3+HDFnew7212Q4;
HDFnew7212D = HDFnew7212D1+HDFnew7212D2+HDFnew7212D3+HDFnew7212D4;
