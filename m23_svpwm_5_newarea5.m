...
for i=1:fsw*time%Plane1
    ...
    P3 = Qz(i)+Q1(i);
    P4 = Qz(i)+Q1(i)+Q2(i);
    P5 = Qz(i)+Q1(i)+Q2(i)+Q3(i)*fraction5;
    P6 = Qz(i)+Q1(i)+Q2(i)+Q3(i)*fraction5+Q4(i);
    P7 = Qz(i)+Q1(i)+Q2(i)+Q3(i)+Q4(i);
    ...
    R3 = Dz(i)+D1(i);
    R4 = Dz(i)+D1(i)+D2(i);
    R5 = Dz(i)+D1(i)+D2(i)+D3(i)*fraction5;
    R6 = Dz(i)+D1(i)+D2(i)+D3(i)*fraction5+D4(i);
    R7 = Dz(i)+D1(i)+D2(i)+D3(i)+D4(i);
    ...
    P3 = Qz(i)+Q4(i);
    P4 = Qz(i)+Q4(i)+Q3(i);
    P5 = Qz(i)+Q4(i)+Q3(i)+Q2(i)*fraction5;
    P6 = Qz(i)+Q4(i)+Q3(i)+Q2(i)*fraction5+Q1(i);
    P7 = Qz(i)+Q4(i)+Q3(i)+Q2(i)+Q1(i);
    ...
    R3 = Dz(i)+D4(i);
    R4 = Dz(i)+D4(i)+D3(i);
    R5 = Dz(i)+D4(i)+D3(i)+D2(i)*fraction5;
    R6 = Dz(i)+D4(i)+D3(i)+D2(i)*fraction5+D1(i);
    R7 = Dz(i)+D4(i)+D3(i)+D2(i)+D1(i);
...
for i=1:fsw*time%Plane2
    ...
    P3 = Q9(i)+Q5(i);
    P4 = Q9(i)+Q5(i)+Q6(i);
    P5 = Q9(i)+Q5(i)+Q6(i)+Q7(i)*fraction5;
    P6 = Q9(i)+Q5(i)+Q6(i)+Q7(i)*fraction5+Q8(i);
    P7 = Q9(i)+Q5(i)+Q6(i)+Q7(i)+Q8(i);
    ...
    R3 = D9(i)+D5(i);
    R4 = D9(i)+D5(i)+D6(i);
    R5 = D9(i)+D5(i)+D6(i)+D7(i)*fraction5;
    R6 = D9(i)+D5(i)+D6(i)+D7(i)*fraction5+D8(i);
    R7 = D9(i)+D5(i)+D6(i)+D7(i)+D8(i);
    ...
    P3 = Q9(i)+Q8(i);
    P4 = Q9(i)+Q8(i)+Q7(i);
    P5 = Q9(i)+Q8(i)+Q7(i)+Q6(i)*fraction5;
    P6 = Q9(i)+Q8(i)+Q7(i)+Q6(i)*fraction5+Q5(i);
    P7 = Q9(i)+Q8(i)+Q7(i)+Q6(i)+Q5(i);
    ...
    R3 = D9(i)+D8(i);
    R4 = D9(i)+D8(i)+D7(i);
    R5 = D9(i)+D8(i)+D7(i)+D6(i)*fraction5;
    R6 = D9(i)+D8(i)+D7(i)+D6(i)*fraction5+D5(i);
    R7 = D9(i)+D8(i)+D7(i)+D6(i)+D5(i);
...
HDFnew0121 = HDFnew0121Q_p1 + HDFnew0121D_p1 + HDFnew0121Q_p2 + HDFnew0121D_p2;
HDFnew7212 = HDFnew7212Q_p1 + HDFnew7212D_p1 + HDFnew7212Q_p2 + HDFnew7212D_p2;
...
for i=1:fsw*time%璶祘Α絏
   switch minHDFcase5(i)
       ...
       case 4%new012343
           ...
           out1=repmat(v1(:,i),1,T1bit(i));
           out2=repmat(v2(:,i),1,T2bit(i));
           out3=repmat(v3(:,i),1,floor(T3bit(i)*fraction5));
           out4=repmat(v4(:,i),1,T4bit(i));
           out7=repmat(v3(:,i),1,T3bit(i)-floor(T3bit(i)*fraction5));
           outnew012343=[out0 out1 out2 out3 out4 out7 out7 out4 out3 out2 out1 out0];
           out(:,bit*(i-1)+1:bit*i)=outnew012343;
       case 5%new743212
           out0=repmat([1;1;1;1;1],1,Tzbit(i));
           out1=repmat(v4(:,i),1,T4bit(i));
           out2=repmat(v3(:,i),1,T3bit(i));
           out3=repmat(v2(:,i),1,floor(T2bit(i)*fraction5));
           out4=repmat(v1(:,i),1,T1bit(i));
           out7=repmat(v2(:,i),1,T2bit(i)-floor(T2bit(i)*fraction5));
           outnew743212=[out0 out1 out2 out3 out4 out7 out7 out4 out3 out2 out1 out0];
           out(:,bit*(i-1)+1:bit*i)=outnew743212;
   end
end
