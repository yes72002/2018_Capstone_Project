...
% end
% figure,quiver(zeros(1,126),zeros(1,126),DQ(3,:),DQ(4,:)),title('dq-plane 2'); 
% for i=1:126
%     k=num2str(i);
%     text(DQ(3,i),DQ(4,i),k);
% end
% figure,quiver(zeros(1,126),zeros(1,126),DQ(5,:),DQ(6,:)),title('dq-plane 3'); 
% for i=1:126
%     k=num2str(i);
...
for i=1:fsw*time
    ...
    Dz_p3(i)=0;
    v1(:,i)=dec2bin(sb1(i),7)-48;
    v2(:,i)=dec2bin(sb2(i),7)-48;
    v3(:,i)=dec2bin(sb3(i),7)-48;
    v4(:,i)=dec2bin(sb4(i),7)-48;
    v5(:,i)=dec2bin(sb5(i),7)-48;
    v6(:,i)=dec2bin(sb6(i),7)-48;
end
T1=duty(1,:);%礚&Τ弘非
T2=duty(2,:);
T3=duty(3,:);
