...
for i = 1:fsw*time%主要的大程式碼
    ...
    switch minHDFcase3(i)
        case 1%0127
            out000 = repmat([0;0;0]+ud,1,T0bit(i));
            out001 = repmat(v1(:,i)+ud,1,T1bit(i));
            out011 = repmat(v2(:,i)+ud,1,T2bit(i));
            out111 = repmat([1;1;1]+ud,1,T3bit(i));
