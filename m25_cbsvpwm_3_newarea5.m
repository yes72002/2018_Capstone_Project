...
for i=1:fsw*time
    ...
    P1 = 0;
    P2 = Xz(i);
    P3 = Xz(i)+X1(i)*fraction5;
    P4 = Xz(i)+X1(i)*fraction5+X2(i);
    P5 = Xz(i)+X1(i)+X2(i);
    HDFnew0121X1(i)=((P1)^2+(P1)*(P2)+(P2)^2)*Tz(i);
    HDFnew0121X2(i)=((P2)^2+(P2)*(P3)+(P3)^2)*T1(i)*fraction5;
    HDFnew0121X3(i)=((P3)^2+(P3)*(P4)+(P4)^2)*T2(i);
    HDFnew0121X4(i)=((P4)^2+(P4)*(P5)+(P5)^2)*T1(i)*(1-fraction5);    
    R1 = 0;
    R2 = Yz(i);
    R3 = Yz(i)+Y1(i)*fraction5;
    R4 = Yz(i)+Y1(i)*fraction5+Y2(i);
    R5 = Yz(i)+Y1(i)+Y2(i);
    HDFnew0121Y1(i)=((R1)^2+(R1)*(R2)+(R2)^2)*Tz(i);
    HDFnew0121Y2(i)=((R2)^2+(R2)*(R3)+(R3)^2)*T1(i)*fraction5;
    HDFnew0121Y3(i)=((R3)^2+(R3)*(R4)+(R4)^2)*T2(i);
    HDFnew0121Y4(i)=((R4)^2+(R4)*(R5)+(R5)^2)*T1(i)*(1-fraction5);
    %HDFnew7212
    P1 = 0;
    P2 = Xz(i);
    P3 = Xz(i)+X2(i)*fraction5;
    P4 = Xz(i)+X2(i)*fraction5+X1(i);
    P5 = Xz(i)+X2(i)+X1(i);
    HDFnew7212X1(i)=((P1)^2+(P1)*(P2)+(P2)^2)*Tz(i);
    HDFnew7212X2(i)=((P2)^2+(P2)*(P3)+(P3)^2)*T2(i)*fraction5;
    HDFnew7212X3(i)=((P3)^2+(P3)*(P4)+(P4)^2)*T1(i);
    HDFnew7212X4(i)=((P4)^2+(P4)*(P5)+(P5)^2)*T2(i)*(1-fraction5);
    R1 = 0;
    R2 = Yz(i);
    R3 = Yz(i)+Y2(i)*fraction5;
    R4 = Yz(i)+Y2(i)*fraction5+Y1(i);
    R5 = Yz(i)+Y2(i)+Y1(i);
    HDFnew7212Y1(i)=((R1)^2+(R1)*(R2)+(R2)^2)*Tz(i);
    HDFnew7212Y2(i)=((R2)^2+(R2)*(R3)+(R3)^2)*T2(i)*fraction5;
    HDFnew7212Y3(i)=((R3)^2+(R3)*(R4)+(R4)^2)*T1(i);
    HDFnew7212Y4(i)=((R4)^2+(R4)*(R5)+(R5)^2)*T2(i)*(1-fraction5);
end
...
HDFnew0121X = HDFnew0121X1+HDFnew0121X2+HDFnew0121X3+HDFnew0121X4;
HDFnew0121Y = HDFnew0121Y1+HDFnew0121Y2+HDFnew0121Y3+HDFnew0121Y4;
HDFnew0121 = HDFnew0121X+HDFnew0121Y;
HDFnew7212X = HDFnew7212X1+HDFnew7212X2+HDFnew7212X3+HDFnew7212X4;
HDFnew7212Y = HDFnew7212Y1+HDFnew7212Y2+HDFnew7212Y3+HDFnew7212Y4;
