...
for i=1:1:fsw*time%01234567
    ...
    P5=Qz(i)+Q1(i)+Q2(i)+Q3(i);
    P6=Qz(i)+Q1(i)+Q2(i)+Q3(i)+Q4(i);
    P7=Qz(i)+Q1(i)+Q2(i)+Q3(i)+Q4(i)+Q5(i)*fraction5;
    P8=Qz(i)+Q1(i)+Q2(i)+Q3(i)+Q4(i)+Q5(i)*fraction5+Q6(i);
    P9=Qz(i)+Q1(i)+Q2(i)+Q3(i)+Q4(i)+Q5(i)+Q6(i);
    HDFnew0121Q1(i)=((P1)^2+(P1)*(P2)+(P2)^2)*Tz(i);
    HDFnew0121Q2(i)=((P2)^2+(P2)*(P3)+(P3)^2)*T1(i);
    HDFnew0121Q3(i)=((P3)^2+(P3)*(P4)+(P4)^2)*T2(i);
    HDFnew0121Q4(i)=((P4)^2+(P4)*(P5)+(P5)^2)*T3(i);
    HDFnew0121Q5(i)=((P5)^2+(P5)*(P6)+(P6)^2)*T4(i);
    HDFnew0121Q6(i)=((P6)^2+(P6)*(P7)+(P7)^2)*T5(i)*fraction5;
    HDFnew0121Q7(i)=((P7)^2+(P7)*(P8)+(P8)^2)*T6(i);
    HDFnew0121Q8(i)=((P8)^2+(P8)*(P9)+(P9)^2)*T5(i)*(1-fraction5);
    R1=0;
    R2=Dz(i);
    R3=Dz(i)+D1(i);
    R4=Dz(i)+D1(i)+D2(i);
    R5=Dz(i)+D1(i)+D2(i)+D3(i);
    R6=Dz(i)+D1(i)+D2(i)+D3(i)+D4(i);
    R7=Dz(i)+D1(i)+D2(i)+D3(i)+D4(i)+D5(i)*fraction5;
    R8=Dz(i)+D1(i)+D2(i)+D3(i)+D4(i)+D5(i)*fraction5+D6(i);
    R9=Dz(i)+D1(i)+D2(i)+D3(i)+D4(i)+D5(i)+D6(i);
    HDFnew0121D1(i)=((R1)^2+(R1)*(R2)+(R2)^2)*Tz(i);
    HDFnew0121D2(i)=((R2)^2+(R2)*(R3)+(R3)^2)*T1(i);
    HDFnew0121D3(i)=((R3)^2+(R3)*(R4)+(R4)^2)*T2(i);
    HDFnew0121D4(i)=((R4)^2+(R4)*(R5)+(R5)^2)*T3(i);
    HDFnew0121D5(i)=((R5)^2+(R5)*(R6)+(R6)^2)*T4(i);
    HDFnew0121D6(i)=((R6)^2+(R6)*(R7)+(R7)^2)*T5(i)*fraction5;
    HDFnew0121D7(i)=((R7)^2+(R7)*(R8)+(R8)^2)*T6(i);
    HDFnew0121D8(i)=((R8)^2+(R8)*(R9)+(R9)^2)*T5(i)*(1-fraction5);
    P1=0;%new76543212
    P2=Qz(i);
    P3=Qz(i)+Q6(i);
    P4=Qz(i)+Q6(i)+Q5(i);
    P5=Qz(i)+Q6(i)+Q5(i)+Q4(i);
    P6=Qz(i)+Q6(i)+Q5(i)+Q4(i)+Q3(i);
    P7=Qz(i)+Q6(i)+Q5(i)+Q4(i)+Q3(i)+Q2(i)*fraction5;
    P8=Qz(i)+Q6(i)+Q5(i)+Q4(i)+Q3(i)+Q2(i)*fraction5+Q1(i);
    P9=Qz(i)+Q6(i)+Q5(i)+Q4(i)+Q3(i)+Q2(i)+Q1(i);
    HDFnew7212Q1(i)=((P1)^2+(P1)*(P2)+(P2)^2)*Tz(i);
    HDFnew7212Q2(i)=((P2)^2+(P2)*(P3)+(P3)^2)*T6(i);
    HDFnew7212Q3(i)=((P3)^2+(P3)*(P4)+(P4)^2)*T5(i);
    HDFnew7212Q4(i)=((P4)^2+(P4)*(P5)+(P5)^2)*T4(i);
    HDFnew7212Q5(i)=((P5)^2+(P5)*(P6)+(P6)^2)*T3(i);
    HDFnew7212Q6(i)=((P6)^2+(P6)*(P7)+(P7)^2)*T2(i)*fraction5;
    HDFnew7212Q7(i)=((P7)^2+(P7)*(P8)+(P8)^2)*T1(i);
    HDFnew7212Q8(i)=((P8)^2+(P8)*(P1)+(P1)^2)*T2(i)*(1-fraction5);
    R1=0;
    R2=Dz(i);
    R3=Dz(i)+D6(i);
    R4=Dz(i)+D6(i)+D5(i);
    R5=Dz(i)+D6(i)+D5(i)+D4(i);
    R6=Dz(i)+D6(i)+D5(i)+D4(i)+D3(i);
    R7=Dz(i)+D6(i)+D5(i)+D4(i)+D3(i)+D2(i)*fraction5;
    R8=Dz(i)+D6(i)+D5(i)+D4(i)+D3(i)+D2(i)*fraction5+D1(i);
    R9=Dz(i)+D6(i)+D5(i)+D4(i)+D3(i)+D2(i)+D1(i);
    HDFnew7212D1(i)=((R1)^2+(R1)*(R2)+(R2)^2)*Tz(i);
    HDFnew7212D2(i)=((R2)^2+(R2)*(R3)+(R3)^2)*T6(i);
    HDFnew7212D3(i)=((R3)^2+(R3)*(R4)+(R4)^2)*T5(i);
    HDFnew7212D4(i)=((R4)^2+(R4)*(R5)+(R5)^2)*T4(i);
    HDFnew7212D5(i)=((R5)^2+(R5)*(R6)+(R6)^2)*T3(i);
    HDFnew7212D6(i)=((R6)^2+(R6)*(R7)+(R7)^2)*T2(i)*fraction5;
    HDFnew7212D7(i)=((R7)^2+(R7)*(R8)+(R8)^2)*T1(i);
    HDFnew7212D8(i)=((R8)^2+(R8)*(R1)+(R1)^2)*T2(i)*(1-fraction5);
end
...
HDFnew0121Q=HDFnew0121Q1+HDFnew0121Q2+HDFnew0121Q3+HDFnew0121Q4+HDFnew0121Q5+HDFnew0121Q6+HDFnew0121Q7+HDFnew0121Q8;
HDFnew0121D=HDFnew0121D1+HDFnew0121D2+HDFnew0121D3+HDFnew0121D4+HDFnew0121D5+HDFnew0121D6+HDFnew0121D7+HDFnew0121D8;
HDFnew0121=HDFnew0121Q+HDFnew0121D;
HDFnew7212Q=HDFnew7212Q1+HDFnew7212Q2+HDFnew7212Q3+HDFnew7212Q4+HDFnew7212Q5+HDFnew7212Q6+HDFnew7212Q7+HDFnew7212Q8;
HDFnew7212D=HDFnew7212D1+HDFnew7212D2+HDFnew7212D3+HDFnew7212D4+HDFnew7212D5+HDFnew7212D6+HDFnew7212D7+HDFnew7212D8;
