...
degree=angle*180/pi;
% plot(degree,HDF,'r','linewidth', 1);
title(['allHDF(',num2str(fraction5),')']),hold on;
% plot(degree,HDF0121,'b','linewidth', 1),hold on;
% plot(degree,HDF7212,'g','linewidth', 1),hold on;
% plot(degree,minHDFvalue3,'m'),hold on;
% plot(degree,HDFnew0121,'c','linewidth', 1),hold on;
% plot(degree,HDFnew7212,'y','linewidth', 1),hold on;
plot(degree,minHDFvalue5,'k'),hold on;
axis([0 36 0.01 0.026])
...
% % plot(sindq1y,sindq1x),title('sindq1x,sindq1y');
% degree=angle*180/pi;
% plot(degree,HDF,'r','linewidth', 2);
% title(['allHDF(',num2str(fraction5),')']),hold on;
% plot(degree,HDF0121,'b','linewidth', 2),hold on;
% plot(degree,HDF7212,'g','linewidth', 2),hold on;
% % plot(degree,minHDFvalue3,'m'),hold on;
% plot(degree,HDFnew0121,'c','linewidth', 2),hold on;
% plot(degree,HDFnew7212,'y','linewidth', 2),hold on;
% % plot(degree,minHDFvalue5,'k'),hold on;
% axis([0 36 0.01 inf])
