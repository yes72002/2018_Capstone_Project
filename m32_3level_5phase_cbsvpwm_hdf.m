...
Dutym = Dutyz/2;
X0_p1 = (vdq0(1,:)-sindq_p1x).*Dutym;%v0在dq平面1上x軸
...
X5_p1 = (vdq5(1,:)-sindq_p1x).*Dutym;%v5在dq平面1上x軸
Y0_p1 = (vdq0(2,:)-sindq_p1y).*Dutym;%v1在dq平面1上y軸
...
Y5_p1 = (vdq5(2,:)-sindq_p1y).*Dutym;%v5在dq平面1上y軸
X0_p2 = (vdq0(3,:)-sindq_p2x).*Dutym;%v1在dq平面2上x軸
...
X5_p2 = (vdq5(3,:)-sindq_p2x).*Dutym;%v5在dq平面2上x軸
Y0_p2 = (vdq0(4,:)-sindq_p2y).*Dutym;%v0在dq平面2上y軸
...
Y5_p2 = (vdq5(4,:)-sindq_p2y).*Dutym;%v5在dq平面2上y軸
Xz_p1 = X0_p1 + X5_p1;
Xz_p2 = X0_p2 + X5_p2;
Yz_p1 = Y0_p1 + Y5_p1;
Yz_p2 = Y0_p2 + Y5_p2;
