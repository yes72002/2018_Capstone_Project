...
%     end
% end
% HDF0121=fliplr(HDF0121(1:end/2));
% y=fliplr(degree(1:end/2));
% fill([degree(1:end/2) y], [HDF(1:end/2) HDF0121],'b')
% HDF7212=fliplr(HDF7212(1:end/2));
% y=fliplr(degree(1:end/2));
% fill([degree(1:end/2) y], [HDF(1:end/2) HDF7212],'b')